...
public class EcranDePresentation extends Application{
	...
	public void start(Stage stage) throws Exception {
		...
		fc.setInitialDirectory(new File(System.getProperty("user.home")));              //config pour ouverture en local --> l� o� on travaille
				 
//		fc.getExtensionFilters().addAll(new FileChooser.ExtensionFilter("DON", ".don"));   //ouvrir que les fichiers en .don
		
		File fichierSelectionne = fc.showOpenDialog(stage);                             //fenetre de dialogue pour choisir un fichier

		if (fichierSelectionne != null) {
			chemin = fichierSelectionne.toString();
//			chemin = chemin.replace("\", "/");     //marche poooooo
